...
REMOTE_BASE="/home/warehouse-app-production/application"
...
DB2_LIBRARY=RANDM_PROD
ENVIRONMENT=prod
PORT=7501
JWT_EXPIRY=36000s
PRO_DETAIL_PATH=/home/FTP/PRODETAIL
FREIGHT_IMAGE_PATH=/home/warehouse-app-production/uploads/freight-images
BAD_FREIGHT_IMAGE_PATH=/home/warehouse-app-production/uploads/bad-freight-images
WAREHOUSE_IMAGE_PATH=/home/warehouse-app-production/uploads/warehouse-images
WAREHOUSE_DOC_PATH=/home/warehouse-app-production/uploads/warehouse-docs
TEMP_RECEIPT_OUTPUT=/home/warehouse-app-production/uploads/temp-receipt-output
ENVFILE
...
cd $REMOTE_BASE || exit 0
  ...
  npx pm2 delete "New-Warehouse-Prod" || true
cd $REMOTE_BASE
...
npx pm2 start index.js --name "New-Warehouse-Prod"
npx pm2 save
EOF
